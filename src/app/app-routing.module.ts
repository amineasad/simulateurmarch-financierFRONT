...
const routes: Routes = [
  ...
  // Bots
  { path: 'bots/dashboard', component: BotDashboardComponent },
  { path: 'bots/marketplace', component: BotMarketplaceComponent },
  { path: 'bots/create', component: BotBuilderComponent },
  { path: 'bots/edit/:id', component: BotBuilderComponent },
